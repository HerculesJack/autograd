...
class gaussian_kde(object):
    ...
    evaluate
    __call__
    integrate_gaussian (NOT IMPLEMENTED)
    integrate_box_1d (NOT IMPLEMENTED)
    integrate_box (NOT IMPLEMENTED)
    integrate_kde (NOT IMPLEMENTED)
    pdf
    logpdf
    resample
    set_bandwidth
    ...
    def evaluate(self, points):
        ...
        axis : None or 1-d array like, optional
            If not none, return marginal pdf along given axis or axes.
        Returns
        -------
